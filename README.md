...
### 2. Update the files yourself
For larger changes, entire new characters or if you just want to help me out a little, you can use the same tool I used to update the path data yourself. To do this, press CTRL+SHIFT+E on the website and check out the [map making tool's repository](https://github.com/Myrktil/paths-of-the-fallen) for a guide to using the edit menu. Afterwards, you can open a pull request in this repository with your changes or send me the exported json files using the contact methods mentioned above.
